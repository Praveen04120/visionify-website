...
import { LayoutDashboard, Image as ImageIcon, PlusCircle, MessageSquare, LogOut, Mailbox, Menu, X, Briefcase, Users } from "lucide-react";
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: "Job Applications", href: "/admin/job-applications", icon: <Users size={20} /> },
